...
#define PROJECT_BINARY_DIR "/home/tylersdurden/2021/Learning/Audio"

// Example Functions using AudioFile Library
// Which can be found at: github.com/adamstark/AudioFile
 namespace examples {
...
namespace examples{
    ...
    void loadAudioFileAndPrintSummary(){
        ...
        const std::string filePath = std::string (PROJECT_BINARY_DIR) + "/the_weight.wav";
    ...
    void loadAudioFileAndProcessSamples(){
        // 1. Set a file path to an audio file on your machine
        const std::string inputFilePath = std::string (PROJECT_BINARY_DIR) + "/the_weight.wav";
